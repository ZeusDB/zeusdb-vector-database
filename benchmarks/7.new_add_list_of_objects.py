...
# Format 2: List of objects (most common from ML pipelines)
batch_data = [
    {"id": "doc2", "values": np.random.rand(384).tolist(), "metadata": {"type": "blog"}},
    {"id": "doc3", "values": np.random.rand(384).tolist(), "metadata": {"type": "news"}},
]
result = index.add(batch_data)
