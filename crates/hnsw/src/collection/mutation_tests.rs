...
//! issued and its postings being written. `add_metadata` takes the guard as
//! every other durable mutation does. And the stamp training records is a
//! parameter, read from the clock at the trigger and handed down.
